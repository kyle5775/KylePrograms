...
<link rel="stylesheet" href="pain.css" media="screen">
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ms-auto ">
        <li class="nav-item ">
          <a class="nav-link active" aria-current="page"  href="mainmenu.php">Main Menu</a>
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
            <li><a class="dropdown-item" href="list_users.php">User List</a></li>
            <li><a class="dropdown-item" href="app_list.php">Appointment List</a></li>
            <li><a class="dropdown-item" href="sea_uid.php">Search user by user ID</a></li>
            <li><a class="dropdown-item" href="sea_app.php">Search Client by appointment date</a></li>
			<li><a class="dropdown-item" href="delUser.php">Delete User</a></li>
			<li><a class="dropdown-item" href="delapp.php">Delete Appointment</a></li>
 ...
 <table border = "1">
	   ...
	   <td><button><a href="list_users.php" ><span style="color:black">User List</a></td>

	    <td><button><a href="app_list.php" ><span style="color:black">Appointment List</a></td>
		</tr>
		<tr>
		<td><button><a href="sea_uid.php" ><span style="color:black"> Search user by user ID</a></td>
	    <td><button><a href="sea_app.php"><span style="color:black">Search Client by appointment date</a></td>
		</tr>
		<tr>
		<td><button><a href="delUser.php" ><span style="color:black">Delete User</a></td>
	    <td><button><a href="delapp.php" ><span style="color:black">Delete Appointment</a></td>
		</tr>
		</table>
