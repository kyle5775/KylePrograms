...
<html style="font-size: 16px;">
  ...
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.0-beta1/dist/js/bootstrap.bundle.min.js" integrity="sha384-pprn3073KE6tl6bjs2QrFaJGz5/SUsLqktiwsUTF55Jfv3qYSDhgCecCxMW52nD2" crossorigin="anonymous"></script>
   <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.0-beta1/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-0evHe/X+R7YkIZDRvuzKMRqM+OrBnVFBL6DOitfPri4tjfHxaWutUpFmBp4vmVor" crossorigin="anonymous">
    ...
    <title>Create An Apointment</title>
          ...
          <div class="u-layout-row">
            ...
            <div class="u-align-center u-container-style u-grey-5 u-layout-cell u-size-30 u-layout-cell-2">
              <div class="u-container-layout u-valign-middle u-container-layout-2">
                <div align="center">
					<form method="POST" action="app_create.php">
					
<h3> <i> Create An Apointment <i></h3>
					<br>
					<label>
					Full name:<BR><input type="text" name="Fname"required> 
					</label><br>
					<label>
					
					Phone Number:<BR><input type="text" size="20" name="num" required>
					</label>
					<label>
					<br>
					...
					<?php
					if(isset($_GET["error"])){
	 if($_GET["error"] == "Appointmenttaken"){
		
		echo "<span style=\"color:red;\">";
		 echo"The Appointment Date And Time Is Taken. Please Change It"; 
		 echo "</span>";
		  echo" <br>";
					}}	?>
...
<p>Hard Gell Fullsets</p>

  <input type="radio" name="Tnails" value="Hard Gell Fullsets - Long"required>
Long - $110

  <input type="radio" name="Tnails" value="Hard Gell Fullsets - medium"required>
Medium - $100

  <input type="radio" name="Tnails" value="Hard Gell Fullsets - short"required>
Short - $90

  <input type="radio" name="Tnails" value="Hard Gell Fullsets - Refills"required>
Refills - $70
<p>Acrylic Fullsets</p>

  <input type="radio" name="Tnails" value="Acrylic Fullsets - Long"required>
Long - $85

  <input type="radio" name="Tnails" value="Acrylic Fullsets - meduim"required>
Medium - $75

  <input type="radio" name="Tnails" value="Acrylic Fullsets - short"required>
Short - $65

  <input type="radio" name="Tnails" value="Acrylic Fullsets - Refills"required>
Refills - $60
  <p>Gel Polish Only</p>
  <input type="radio" name="Tnails" value="Gel Polish Only - Hands"required>
Hands - $35

  <input type="radio" name="Tnails" value="Gel Polish Only - Toes"required>
Toes - $35
<input type="radio" name="Tnails" value="Gel Polish Only - Toes And Hands"required>
Hands And Toes - $70
<br>
<br>
Toe Enhancements:
<br>
 ...
 Acrylic Tip w/ gel polish $50
 <br>
 <input type="checkbox"  name="TF" id = "TF"><br>
   Please Note add Ons: 
   Glitter $5 per nail, 
   Gems $5 per nail, 
   Nail Art $5 per nail
...
*All Fullsets come with 2 complimentary glitter nails, if desired.
 <br>
					<input type="submit" value="Create" /><input type="reset" value="Start Over"/>
 <br>
<input type = "button" onclick = "myFunction()" value ="Display Total">
					</form>
					<div id="result">
					Total go here
					<br> 
