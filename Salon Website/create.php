      ...
      <ul class="navbar-nav ms-auto ">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
            <li><a class="dropdown-item" href="signin_create.php">Sign-in</a></li>
            <li><a class="dropdown-item" href="create.php">Create an account</a></li>
            <li>
		 ...
		 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<li class="nav-item">
          <a class="nav-link active" href="signin.php">Admin Login</a>
		    </li>
      </ul>
          ...
          <div class="u-layout-row">
            ...
            <div class="u-align-center u-container-style u-grey-5 u-layout-cell u-size-30 u-layout-cell-2">
              <div class="u-container-layout u-valign-middle u-container-layout-2">
                <div align="center">
					<form method="POST" action="create101.php">
<h1> <i> Create An Account<i></h1>
					...
					<label>
					<BR><input type="password" name="passwordrep" placeholder="Repeat password..."> 
					</label><br> 
					<br><br>
					<input type="submit" name="submit"  value="Sign up" /><input type="reset" value="Clear"/>
 ...
 if(isset($_GET["error"])){
	 if($_GET["error"] == "emptyinput"){
		...
		echo "<span style=\"color:red;\">";
		 echo"<h2> Fill in all Fields Please!</h2>"; 
		 echo"<h2>";
 }
	 ...
	 echo" <br>";
		  echo" <br>";
		  echo "<span style=\"color:red;\">";
	 echo" <h2>Invaild Username try another one!!</h2>";
 }
 else if($_GET["error"] == "invalidemail"){
	 echo" <br>";
		  echo" <br>";
		  echo "<span style=\"color:red;\">";
	 echo"<h2> Invaild email!!</h2>";
 }
	 ...
	 echo"<h2>Passwords don't match!!</h2>";
		 ...
		 echo" <br>";
		  echo" <br>";
		  echo "<span style=\"color:red;\">";
	 echo"<h2> Username or Email is already taken!!</h2>";
	 }
