...
<html style="font-size: 16px;">
  ...
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.0-beta1/dist/js/bootstrap.bundle.min.js" integrity="sha384-pprn3073KE6tl6bjs2QrFaJGz5/SUsLqktiwsUTF55Jfv3qYSDhgCecCxMW52nD2" crossorigin="anonymous"></script>
   <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.0-beta1/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-0evHe/X+R7YkIZDRvuzKMRqM+OrBnVFBL6DOitfPri4tjfHxaWutUpFmBp4vmVor" crossorigin="anonymous">
    ...
    <title>Administrator Search Apointment</title>
  ...
  <div class="container">
      ...
      <ul class="navbar-nav ms-auto ">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
			...
			<li><a class="dropdown-item" href="delapp.php">Delete Apointment</a></li>
    ...
    <section class="u-clearfix u-section-1" id="carousel_0d8a">
      <div class="u-clearfix u-expanded-width u-layout-wrap u-layout-wrap-1">
        ...
        <?php
						...
						echo"<br/><br/>";
						//Query the table
						$result = mysqli_query($conn,"SELECT*From appointments where DateTime = '$DateTime'");
    ...
    echo "<table border='1'>";
               ...
               echo "<td>" . $row['FulName'] . "</td>";
                 ...
                 echo " <tr>";
                    echo"<th>Sevice</th>";
                    echo "<td>" . $row['Sevice'] . "</td>";
                     echo " </tr>";
                 echo " <tr>";
                    echo"<th>Toe Enhancements</th>";
                     echo "<td>" . $row['ToeEnhancements'] . "</td>";
                      echo "</tr>";
					   echo "</table>";
            }
