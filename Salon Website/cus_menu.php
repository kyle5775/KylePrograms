...
<link rel="stylesheet" href="pain.css" media="screen">
 ...
 <table border = "1">
	   ...
	   <td><button><a href="cre_app.php" ><span style="color:black">Create an appointment</a></td>

	    <td><button><a href="sc_form.php" ><span style="color:black">See current appointment</a></td>
		</tr>
		<tr>
		<td colspan = "2"><button><a href="cc_form.php" ><span style="color:black">Cancel current appointment</a></td>
		</tr>
