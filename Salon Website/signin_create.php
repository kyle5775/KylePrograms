          ...
          <div class="u-layout-row">
            ...
            <div class="u-align-center u-container-style u-grey-5 u-layout-cell u-size-30 u-layout-cell-2">
              <div class="u-container-layout u-valign-middle u-container-layout-2">
                <div align="center">
					<form method="POST" action="login101.php">
<h1> <i> Sign-in<i></h1>
					<br><br>
					<label>
					Username/Email:<BR><input type="text" name="uid"> 
					</label><br><br> 
					<label>
					Password:<BR><input type="password" size="20" name="password" required>
					</label>
					<br><br>
					<input type="submit" value="Sign-in" /><input type="reset" value="Clear"/>

					</form>
	<h2> If you don't have an account click <a href="create.php" > here </a> </h2>
	<?php
 if(isset($_GET["error"])){
	 if($_GET["error"] == "emptyinput"){
		 echo" Fill in all Fields!!</p>";
 }
